...
off disk, and I35 solves the heads-up tree — **53 gates in total** with the rest of the D and V families and the benchmark gate. The counts are derived from `EXPECTED_IDS` in
...
The numbering has one deliberate gap and no accidental ones. I1–I33, I35, I41–I44 and
D10/D11 are live with **I17 retired**
(it went with the sub-bucket layer it asserted, §2.4); **I34, I36–I40, I45–I47 and D9 are reserved,
